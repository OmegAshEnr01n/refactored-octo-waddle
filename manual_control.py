...
w = imageio.get_writer('_out/pipe3.mp4', format='FFMPEG', mode='I', fps=30)
...
class World(object):
    ...
    def render(self, display):
        ...
        array = pygame.surfarray.array3d(display)
            ...
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    world.hud.toggle_info()
                     ...
                     world.hud.notificationCounter("Not stopping at pedestrian crossing: "+ str(world.count))
                     world.count +=1
                     print(world.count)
...
class HUD(object):
    def __init__(self, width, height):
        ...
        self._counter = CounterText(font, (width, 40), (0, 0))
    ...
    def tick(self, world, clock):
        ...
        self._counter.tick(world, clock)
    ...
    def notificationCounter(self, text, seconds=2.0):
        self._counter.set_text(text, seconds=seconds)
...
class FadingText(object):
    ...
    def set_text(self, text, color=(255, 255, 255), seconds=120.0):
